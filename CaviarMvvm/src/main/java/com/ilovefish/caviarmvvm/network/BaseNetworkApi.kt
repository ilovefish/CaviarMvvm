...
abstract class BaseNetworkApi {
     ...
     */
    protected abstract fun setHttpClientBuilder(builder: OkHttpClient.Builder): OkHttpClient.Builder

    /**
     * 实现重写父类的setRetrofitBuilder方法，
     * 在这里可以对Retrofit.Builder做任意操作，比如添加GSON解析器，Protocol
     */
    protected abstract fun setRetrofitBuilder(builder: Retrofit.Builder): Retrofit.Builder
