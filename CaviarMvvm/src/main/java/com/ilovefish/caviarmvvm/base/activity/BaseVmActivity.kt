...
import com.ilovefish.caviarmvvm.ext.getVmClazz
import com.ilovefish.caviarmvvm.ext.util.notNull
...
abstract class BaseVmActivity<VM : BaseViewModel> : AppCompatActivity() {
    ...
    private fun init(savedInstanceState: Bundle?) {
        ...
        createObserver()
        NetworkStateManager.instance.mNetStateLiveData.observe(this, Observer {
